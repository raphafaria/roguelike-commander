...
<body>
  <h1>Decklist - Demis</h1>
  <div class="top-nav">
    <a href="demis.html">⬅ Voltar para Perfil</a>
  </div>
  <div class="deck-section">
    <div class="section-title">Comandante(s)</div>
    <div class="deck-container">
      <div class="card"><img src="Asset/Commander/The Prismatic Bridge.jpg" alt="The Prismatic Bridge" loading="lazy" /></div>
      <div class="card"><img src="Asset/Commander/Oloro, Ageless Ascetic.jpg" alt="Oloro, Ageless Ascetic" loading="lazy" /></div>
    </div>
  </div>
  <div class="deck-section">
